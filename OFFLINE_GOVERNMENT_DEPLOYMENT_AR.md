# دليل تشغيل نظام إدارة المخازن داخل مؤسسة حكومية معزولة
...
لا تنقل النظام إلى الإنتاج حتى تمر الحالات العالية في ملف خطة الاختبار، وتعتمد النتائج إدارة المخازن والأمن وإدارة الشبكات.
